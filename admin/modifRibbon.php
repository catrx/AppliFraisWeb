...
<body>
 <div class="container">
   ...
   <div class="col-sm-3 col-md-2 col-lg-5 pull-left">
   <a href="../public/createribbon.php"><button type="button" class="pull-left btn btn-outline-primary">Ajouter un frais forfaitisé</button></a>
 </div></br></br>
</br><h5>Synthèse du mois :</h5>
<?php
$stmtDateFrais = $DBCon->prepare("SELECT * FROM fichefrais WHERE idVisiteur = ?");
$stmtDateFrais->execute(array($_SESSION['id']));
?>
<form action="" method="post">
<div class="row">
<select class="form-control col-2" name="start">
<?php
...
<input type="submit" class="text-center btn btn-outline-primary" value=" Envoyer " name="submit"/><br />
</div>
</form>
